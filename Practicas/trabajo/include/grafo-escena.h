...
class Cara1 : public NodoGrafoEscena {
public:
	Cara1();
};

class Cara2 : public NodoGrafoEscena {
public:
	Cara2();
};

class Cara3 : public NodoGrafoEscena {
public:
	Cara3();
};

class Cara4 : public NodoGrafoEscena {
public:
	Cara4();
};

class Cara5 : public NodoGrafoEscena {
public:
	Cara5();
};

class Cara6 : public NodoGrafoEscena {
public:
	Cara6();
};
